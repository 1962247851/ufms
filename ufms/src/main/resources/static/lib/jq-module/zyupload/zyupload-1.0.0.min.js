...
var ZYFILE = {
    ...
    funUploadFile: function (file) {
        ...
        formdata.append("uuid", $("#uploadForm").attr("uuid"))
        for (let dataKey in self.data) {
            console.log(datakey, self.data[dataKey])
        }
        ...
        return this.each(function () {
            ...
            this.createHtml = function () {
                ...
                if (para.dragDrop) {
                    ...
                    html += '						<div id="filePicker" class="layui-btn" style="margin: 9px;display: inherit">点击选择文件</div>';
                    ...
                    html += '				<div class="btns">';
                    html += '					<div id="webUploaderPick" class="layui-btn layui-btn-primary">继续选择</div>';
                    html += '					<div class="layui-btn" id="uploadBtn" style="display: ">开始上传</div>';
                    html += "				</div>";
                    html += "			</div>";
                    ...
                    html += '				<div class="btns">';
                    html += '					<input id="fileImage" type="file" size="30" name="fileselect[]" ' + multiple + ">";
                    html += '					<div id="webUploaderPick"  class="layui-btn layui-btn-primary">选择文件</div>';
                    html += '					<div id="uploadBtn" class="layui-btn">开始上传</div>';
                    html += "				</div>";
                    html += "			</div>";
                    ...
                    html += '							<img class="upload_image" src="/lib/jq-module/zyupload/images/add_img.png" style="width:expression(this.width > ' + imgWidth + " ? " + imgWidth + 'px : this.width)" />';
                    html += "						</div>";
                    html += "					</a>";
                    html += "				</div>";
                    html += "			</div>";
                ...
                $(self).prepend(html).css({"width": para.width, "height": para.height});
                this.addEvent()
            };
            ...
            this.funDisposePreviewHtml = function (file, e) {
                ...
                var newStr = file.name.split("").reverse().join("");
                var type = newStr.split(".")[0].split("").reverse().join("");
                var fileImgSrc = "/lib/jq-module/zyupload/images/fileType/";
                if (type == "rar") {
                ...
                if (file.type.indexOf("image") == 0) {
                    ...
                    html += "		</div>";
                    html += "	</div>";
                    html += '	<a data-magnify="gallery" data-caption="' + file.name + '" style="height:' + para.itemHeight + ";width:" + para.itemWidth + ';" href="' + e.target.result + '" class="imgBox">';
            ...
            this.addEvent = function () {
                ...
                $("#webUploaderPick").bind("click", function (e) {
                    $("#fileImage").click()
                });
