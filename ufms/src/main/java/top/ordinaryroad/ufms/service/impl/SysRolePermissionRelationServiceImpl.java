...
import top.ordinaryroad.ufms.dao.SysRolePermissionRelationDao;
import top.ordinaryroad.ufms.entity.SysRolePermissionRelation;
 ...
 */
@Service
public class SysRolePermissionRelationServiceImpl implements top.ordinaryroad.ufms.service.SysRolePermissionRelationService {
    ...
    public boolean deleteById(Long id) {
        ...
        return !sysRolePermissionRelationDao.findById(id).isPresent();
    }
