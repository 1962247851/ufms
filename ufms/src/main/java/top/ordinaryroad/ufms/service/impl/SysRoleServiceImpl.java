...
import top.ordinaryroad.ufms.dao.SysRoleDao;
import top.ordinaryroad.ufms.entity.SysRole;
import top.ordinaryroad.ufms.service.SysRoleService;
...
public class SysRoleServiceImpl implements SysRoleService {
    ...
    public boolean deleteById(Long id) {
        ...
        return !sysRoleDao.findById(id).isPresent();
    }
