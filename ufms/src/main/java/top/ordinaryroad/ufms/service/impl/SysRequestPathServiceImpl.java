...
import top.ordinaryroad.ufms.dao.SysRequestPathDao;
 ...
 */
@Service
public class SysRequestPathServiceImpl implements top.ordinaryroad.ufms.service.SysRequestPathService {
    ...
    public boolean deleteById(Long id) {
        ...
        return !sysRequestPathDao.findById(id).isPresent();
    }
